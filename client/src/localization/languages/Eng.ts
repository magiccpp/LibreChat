...
export default {
  ...
  com_sidepanel_stats_panel: 'Statistics',
  ...
  com_ui_export_conversation: 'Export',
  ...
  com_ui_export_conversation_info: 'Export conversations to OpenAI jsonl fine-tune file',
  com_ui_export_conversation_success: 'Conversations Exported successfully',
  com_ui_export_conversation_error: 'There was an error Exporting your conversations',
  com_ui_export_conversation_file_type_error: 'Unsupported Export type',
